...
%changelog
* Wed Jul 15 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 8-14.osg24up.el8
- Second attempt at enabling xrootd6 build conditional (SOFTWARE-6370)
- Simplify spec file

* Tue Jul 14 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 8-13.osg24up.el8
- Enable xrootd6 build conditional (SOFTWARE-6370)

* Fri Aug 30 2024 Matt Westphall <westphall@wisc.edu> - 8-12
- osg 24 el8 version

* Wed Dec 06 2023 Matt Westphall <westphall@wisc.edu> - 8-11
- Bump again to rebuild with new signing key

* Mon Oct 03 2023 Mátyás Selmeci <matyas@cs.wisc.edu> - 8-10
- Bump to rebuild with new signing key

* Thu Jul 28 2023 Matt Westphall <westphall@wisc.edu>
- osg 23 el8 version

* Fri Dec 30 2022 Carl Edquist <edquist@cs.wisc.edu> - 8-7
