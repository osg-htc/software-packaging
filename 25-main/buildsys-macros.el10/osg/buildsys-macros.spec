...
echo "%%_without_xrootd6 1"  >> $RPM_BUILD_ROOT/etc/rpm/macros.bcond
...
%changelog
* Wed Jul 15 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 10-21.osg25.el10
- Second attempt at disabling xrootd6 build conditional (SOFTWARE-6370)
- Simplify spec file

* Tue Jul 14 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 10-20.osg25.el10
- Explicitly disable xrootd6 build conditional (SOFTWARE-6370)

* Fri Sep 05 2025 Matt Westphall <westphall@wisc.edu> - 10-19.osg25.el10
- osg 25 el10 version

* Fri Jul 25 2025 Mátyás Selmeci <mselmeci@wisc.edu> - 10-16.osg24.el10
- Bump to rebuild

* Thu Jun 19 2025 Mátyás Selmeci <mselmeci@wisc.edu> - 10-14.osg24.el10
