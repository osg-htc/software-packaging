...
%changelog
* Wed Jul 15 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 8-25.osg25.el8
- Second attempt at disabling xrootd6 build conditional (SOFTWARE-6370)
- Simplify spec file

* Tue Jul 14 2026 Mátyás Selmeci <mselmeci@wisc.edu> - 8-24.osg25.el8
- Explicitly disable xrootd6 build conditional (SOFTWARE-6370)

* Fri Sep 05 2025 Matt Westphall <westphall@wisc.edu> - 8-23.osg25.el8
- osg 25 el8 version

* Fri Aug 23 2024 Matt Westphall <westphall@wisc.edu> - 8-20.osg24.el8
- osg 24 el8 version
