...
Requires: cvmfs = 2.14.1
Requires: cvmfs-config-osg = 2.5
Requires: scitokens-cpp >= 1.4.0
...
%changelog
* Wed Aug 05 2026 Dave Dykstra <dwd@fnal.gov> 22-6
- Downgrade required scitokens-cpp to be >= 1.4.0 because 1.4.1 wasn't yet
  built for EPEL10.2

* Mon Aug 03 2026 Dave Dykstra <dwd@fnal.gov> 22-5
- Update to cvmfs-2.14.1
- Update to scitokens-cpp >= 1.4.1

* Tue Jul 07 2026 Carl Vuosalo <covuosalo@wisc.edu> 22-4
- Update to cvmfs-2.14.0

* Tue Jun 30 2026 Dave Dykstra <dwd@fnal.gov> 22-3
- Update to cvmfs-2.14.0~pre5

* Thu May 14 2026 Carl Vuosalo <covuosalo@wisc.edu> 22-2
- Update to cvmfs-2.14.0~pre4

* Tue Apr 21 2026 Dave Dykstra <dwd@fnal.gov> 22-1
- Update to cvmfs-2.14.0~pre3

* Thu Oct 30 2025 Carl Vuosalo <covuosalo@wisc.edu> 21-4
- Update to cvmfs-2.13.3

* Wed Jul 30 2025 Carl Vuosalo <covuosalo@wisc.edu> 21-3
- Update to cvmfs-2.13.2

* Thu Jun 26 2025 Carl Vuosalo <covuosalo@wisc.edu> 21-2
- Update to cvmfs-2.13.1

* Thu May 22 2025 Carl Vuosalo <covuosalo@wisc.edu> 21-1
- Update to cvmfs-2.13.0

* Wed Feb 05 2025 Carl Vuosalo <covuosalo@wisc.edu> 20-15
- Update to cvmfs-2.12.6

* Fri Jan 10 2025 Carl Vuosalo <covuosalo@wisc.edu> 20-14
- Update to cvmfs-2.12.4

* Wed Dec 18 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-13
- Update to cvmfs-2.12.3

* Wed Dec 11 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-12
- Fix build glitch.

* Wed Dec 11 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-11
- Update to cvmfs-2.12.2

* Thu Aug 22 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-10
- Update to cvmfs-2.11.5

* Tue Aug 06 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-9
- Update to cvmfs-2.11.4

* Tue Apr 23 2024 Carl Vuosalo <covuosalo@wisc.edu> 20-8
- Update to cvmfs-2.11.3

* Mon Oct 30 2023 Dave Dykstra <dwd@fnal.gov> 20-7
- Update to cvmfs-2.11.2

* Fri Oct 27 2023 Dave Dykstra <dwd@fnal.gov> 20-6
- Update to cvmfs-x509-helper-2.4
- Update revision to match osg3.6
